<template>
  <div>
    ...
    <div style="display: flex;justify-content: center">
      <div class="cart_box">
        <van-grid column-num="2">
          <van-grid-item icon="add-o" @click="$router.push('/admin/activity/edit?isCreate=true')" />
    ...
    <admin-activity-list ref="userList"></admin-activity-list>
  </div>
</template>

<script>
import AdminActivityList from "@/components/Admin/Activity/AdminActivityList";
export default {
  name: "AdminActivityView",
  components: {AdminActivityList},
  data(){
    return{
      user:{},
      showPop:false,
